...
var timesUpSound=new Audio("music/Time's up.aac");
var winnerSound=new Audio('music/winner_sound.aac');
var firthSound=new Audio('music/50-50.aac');
...
if(currentUser){
  ...
  questionsRef.on('value',(snapshot)=>{
    ...
    if(random_number_array.length==12 && letsPlayQuesSound && finalAnswerSound 
        && quesSound && loseSound && five_last_second_sound && winSound
        && timesUpSound && winnerSound && firthSound && phoneAFriendSound
        && askTheAudienceAudio && askTheAudienceAudio && pickExpertSound
        && phoneExpertSound){
